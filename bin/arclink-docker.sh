...
bootstrap() {
  ...
  ensure_env_file_value ARCLINK_DEFAULT_PRICE_ID "price_arclink_sovereign"
  ...
  ensure_env_file_value ARCLINK_FIRST_AGENT_PRICE_ID "price_arclink_sovereign"
  ensure_env_file_value ARCLINK_ADDITIONAL_AGENT_PRICE_ID "price_arclink_agent_deployment"
  ensure_env_file_value ARCLINK_SOVEREIGN_MONTHLY_CENTS "9900"
  ensure_env_file_value ARCLINK_SCALE_MONTHLY_CENTS "17900"
  ensure_env_file_value ARCLINK_FIRST_AGENT_MONTHLY_CENTS "9900"
  ensure_env_file_value ARCLINK_ADDITIONAL_AGENT_MONTHLY_CENTS "5000"
