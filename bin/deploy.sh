...
emit_runtime_config() {
  ...
  fi
  {
    ...
    write_kv ALMANAC_HERMES_DOCS_REPO_URL "${ALMANAC_HERMES_DOCS_REPO_URL:-https://github.com/NousResearch/hermes-agent.git}"
    write_kv ALMANAC_HERMES_DOCS_REF "${ALMANAC_HERMES_DOCS_REF:-${ALMANAC_HERMES_AGENT_REF:-ce089169d578b96c82641f17186ba63c288b22d8}}"
    ...
    write_kv ALMANAC_HERMES_DOCS_VAULT_DIR "${ALMANAC_HERMES_DOCS_VAULT_DIR:-$VAULT_DIR/Repos/hermes-agent-docs}"
