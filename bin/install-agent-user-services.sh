...
ARCLINK_AGENT_LINKED_DIR="${ARCLINK_AGENT_LINKED_DIR:-$HERMES_HOME/linked}"
mkdir -p "$TARGET_DIR"
...
$(systemd_env_line ARCLINK_DASHBOARD_AGENT_LABEL "${ARCLINK_DASHBOARD_AGENT_LABEL:-$AGENT_ID}")
$(systemd_env_line ARCLINK_DASHBOARD_AGENT_TITLE "${ARCLINK_DASHBOARD_AGENT_TITLE:-}")
$(systemd_env_line ARCLINK_DASHBOARD_THEME "${ARCLINK_DASHBOARD_THEME:-}")
$(systemd_env_line ARCLINK_DASHBOARD_THEME_LABEL "${ARCLINK_DASHBOARD_THEME_LABEL:-}")
$(systemd_env_line ARCLINK_DASHBOARD_ACCENT_HEX "${ARCLINK_DASHBOARD_ACCENT_HEX:-}")
$(if [[ -n "$HERMES_BUNDLED_SKILLS_DIR" ]]; then systemd_env_line HERMES_BUNDLED_SKILLS "$HERMES_BUNDLED_SKILLS_DIR"; fi)
WorkingDirectory=$HERMES_HOME
