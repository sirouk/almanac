...
route catalog; `docs/openapi/arclink-v1.openapi.json` is canonical JSON
equivalent to the spec generated by `build_arclink_openapi_spec()` and is
regenerated on any `_ROUTES` change. For other concerns, cross-reference rather
than duplicate:
