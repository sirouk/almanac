...
_DEFAULT_REMOTE_SETUP_URL = "https://raw.githubusercontent.com/example/almanac/main/bin/setup-remote-hermes-client.sh"
_RELEVANT_TERMS = (
    "/almanac-resources",
    "/almanac-links",
    "almanac",
...
_TOOL_RECIPES: tuple[tuple[str, tuple[str, ...], str], ...] = (
    ...
    (
        ...
        (
            ...
            "For create_page, payload is {\"title\":\"...\",\"children\":[...]} and target_id is the shared parent page or omitted for the configured Almanac root page. "
            "For create_database, payload is {\"title\":\"...\",\"properties\":{...}} and target_id is the shared parent page or omitted for the configured Almanac root page. "
