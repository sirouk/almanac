...
- surface `[managed:recall-stubs]` as compact source-linked awareness cards that name the retrieval rail and source key, including vault, shared Notion, accepted Linked folders, and Fleet shared folders, without treating those cards as answer evidence
