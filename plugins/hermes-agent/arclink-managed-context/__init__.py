...
_RESOURCE_REQUEST_TERMS = (
    ...
    "send me a link to the dashboard",
    "drive link",
    "drive url",
    "code link",
    "code url",
...
_TOKEN_TOOL_SUFFIXES = {
    ...
    "pod_comms_list": "pod_comms.list",
    "pod_comms_send": "pod_comms.send",
    "pod_comms_share_file": "pod_comms.share-file",
    "ssot_read": "ssot.read",
    "ssot_pending": "ssot.pending",
    "ssot_preflight": "ssot.preflight",
    "ssot_status": "ssot.status",
    "ssot_write": "ssot.write",
    "ssot_approve": "ssot.approve",
    "ssot_deny": "ssot.deny",
...
def _identity_payload(payload: dict[str, object]) -> dict[str, str]:
    field_map = (
        ...
        ("academy_role_title", "academy_role"),
        ("academy_manifest_id", "academy_manifest"),
        ("academy_source_count", "academy_sources"),
        ("academy_graduation_status", "academy_graduation"),
