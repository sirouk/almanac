    ...
    prefill_messages = [
        {
            ...
            "content": (
                ...
                + " Treat the installed Almanac skills and plugin-managed [managed:*] context "
                "as active defaults, not passive extras. Use qmd and the wired Almanac "
                ...
                "installed skills, plugin-managed context, and Almanac-provisioned rails first. Treat "
