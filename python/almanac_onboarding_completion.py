...
from almanac_control import Config, config_env_value, get_agent, get_agent_identity, save_onboarding_session
...
def completion_setup_backup_callback_data(session_id: str) -> str:
    return f"almanac:onboarding-complete:setup-backup:{session_id.strip()}"
