...
def build_managed_memory_payload(
    ...
    *,
    ...
    vault_ref = (
        ...
        "Workspace is this agent's writable knowledge and work area; prefer Workspace/Projects for new work, Workspace/Research for agent-local research, Workspace/Repos for repo notes or checkouts, and Workspace/Agents_Skills for skills this agent is building.\n"
        "Fleet is the Captain's shared read/write folder for the Crew, synced across ArcPods and machines; use Fleet/Projects, Fleet/Research, Fleet/Repos, Fleet/Agents_KB, and Fleet/Agents_Skills for material multiple agents should share.\n"
