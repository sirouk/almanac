...
_REDACT_ENV_KEYS = {
    ...
    "CLOUDFLARE_API_TOKEN", "CLOUDFLARE_API_TOKEN_REF", "CHUTES_API_KEY",
    "TELEGRAM_BOT_TOKEN", "DISCORD_BOT_TOKEN",
    "ARCLINK_WORKSPACE_PROOF_AUTH",
    "ARCLINK_HERMES_DASHBOARD_AUTH", "ARCLINK_SSOT_NOTION_TOKEN",
    "ARCLINK_CHUTES_OAUTH_CLIENT_SECRET_REF", "ARCLINK_CHUTES_CREDENTIAL_REF",
    "ARCLINK_CHUTES_REGISTRATION_TOKEN_REF", "ARCLINK_CHUTES_HOTKEY_REF",
}
