...
_ROUTE_DESCRIPTIONS: dict[str, dict[str, Any]] = {
    ...
    "fleet_enrollment_callback": {
        ...
        "requestBody": _openapi_json_body({
            ...
            "wireguard_private_ip": {"type": "string"},
            "wireguard_private_cidr": {"type": "string"},
            "wireguard_public_key": {"type": "string"},
            "wireguard_control_endpoint": {"type": "string"},
            "wireguard_listen_port": {"type": "integer"},
            "wireguard_firewall_status": {"type": "string"},
