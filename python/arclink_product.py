...
_LAUNCH_PHRASES: dict[str, str] = {
    ...
    "completed": "Agent online. ArcLink is ready.",
    "first_contacted": "Agent online. ArcLink is ready.",
    # Deployment statuses
    "entitlement_required": "Payment cleared. Reserving your Agent.",
    "provisioning": "Preparing your Agent. Usually 30 to 90 seconds.",
    "provisioning_ready": "Wiring the lanes. Almost at first light.",
    "active": "Agent online. ArcLink is ready.",
    "provisioning_failed": "Launch hit a snag. ArcLink support is on it.",
