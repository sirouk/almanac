...
LEGACY_PRODUCT_NAME = "Almanac"
DEFAULT_BASE_DOMAIN = "localhost"

ARCLINK_ENV_ALIASES: dict[str, str] = {
    "ARCLINK_PRODUCT_NAME": "ALMANAC_PRODUCT_NAME",
    "ARCLINK_BASE_DOMAIN": "ALMANAC_BASE_DOMAIN",
    "ARCLINK_PRIMARY_PROVIDER": "ALMANAC_PRIMARY_PROVIDER",
    "ARCLINK_CHUTES_BASE_URL": "ALMANAC_CHUTES_BASE_URL",
    "ARCLINK_CHUTES_DEFAULT_MODEL": "ALMANAC_CHUTES_DEFAULT_MODEL",
    "ARCLINK_MODEL_REASONING_DEFAULT": "ALMANAC_MODEL_REASONING_DEFAULT",
}
