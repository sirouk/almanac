...
- generated_at: 2026-05-27T09:13:06Z
- project_root: .
...
| 2 | Python | 018 | requirements-dev.txt,206 python manifest/files |
| 3 | Go | 000 | - |
| 4 | Java | 000 | - |
| 5 | .NET | 000 | - |
| 6 | Ruby | 000 | - |
...
- 2) Python: score=018, evidence=[requirements-dev.txt,206 python manifest/files]
