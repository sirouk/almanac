...
def test_vault_content_notification_copy_is_category_aware() -> None:
    ...
    expect(
        mod._vault_content_notification_message("Agents_Skills", ["almanac-ssot.md"]).startswith("Skill library update: 1 file(s) changed"),
        "expected skill-specific vault notification copy",
    )
    expect(
        mod._vault_content_notification_message("Agents_Plugins", ["almanac-managed-context.md"]).startswith("Plugin library update: 1 file(s) changed"),
