...
def test_activation_trigger_dir_repairs_owner_when_root_creates_or_touches_it() -> None:
    mod = load_module(CONTROL_PY, "arclink_control_activation_trigger_permissions_test")
    with tempfile.TemporaryDirectory() as tmp:
        ...
        try:
            ...
            expect(
                ...
                f"expected activation trigger dir to be chowned to arclink when touched by root, got {chown_calls}",
            )
