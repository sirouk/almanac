...
class TestBuildJourney(unittest.TestCase):
    ...
    def test_external_journey_contains_opt_in_provider_proofs(self):
        ...
        self.assertIn("terminal_tmux_dashboard_restart_proof", names)
        self.assertIn("reload_skills_after_enablement_proof", names)
        self.assertIn("fleet_shared_skill_guard_proof", names)
        self.assertIn("durable_callback_replay_proof", names)
        self.assertIn("discord_agent_media_components_proof", names)
        self.assertIn("discord_free_text_ingress_proof", names)
        self.assertIn("telegram_text_split_batch_proof", names)
