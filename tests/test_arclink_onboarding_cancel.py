...
def test_cancel_wipes_pre_provision_onboarding_state() -> None:
    ...
    control = load_module(CONTROL_PY, "arclink_control_onboarding_cancel_pre_test")
    onboarding = load_module(ONBOARDING_PY, "arclink_onboarding_cancel_pre_test")
...
def test_cancel_refuses_after_provisioning_has_started() -> None:
    if str(PYTHON_DIR) not in sys.path:
        sys.path.insert(0, str(PYTHON_DIR))
    control = load_module(CONTROL_PY, "arclink_control_onboarding_cancel_post_test")
    onboarding = load_module(ONBOARDING_PY, "arclink_onboarding_cancel_post_test")
