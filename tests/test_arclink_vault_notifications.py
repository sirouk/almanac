...
def test_queue_vault_content_notifications_targets_defaulted_and_opted_in_agents() -> None:
    mod = load_module(CONTROL_PY, "arclink_control_vault_notify_test")
...
def test_vault_content_notification_copy_is_category_aware() -> None:
    mod = load_module(CONTROL_PY, "arclink_control_vault_notify_copy_test")
    expect(
        mod._vault_content_notification_message("Agents_Skills", ["arclink-ssot.md"]).startswith("Skill library update: 1 file(s) changed"),
        "expected skill-specific vault notification copy",
    )
    expect(
        mod._vault_content_notification_message("Agents_Plugins", ["arclink-managed-context.md"]).startswith("Plugin library update: 1 file(s) changed"),
        "expected plugin-specific vault notification copy",
    )
    expect(
        mod._vault_content_notification_message("Skills", ["legacy.md"]).startswith("Skill library update: 1 file(s) changed"),
        "expected legacy skill-specific vault notification copy",
    )
    expect(
        mod._vault_content_notification_message("Plugins", ["legacy.md"]).startswith("Plugin library update: 1 file(s) changed"),
        "expected legacy plugin-specific vault notification copy",
    )
    ...
    expect("agent knowledge base" in hermes_message, hermes_message)
