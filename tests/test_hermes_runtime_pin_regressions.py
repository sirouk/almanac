...
PINNED_REF = "49c3c2e0d37c96dc593a807a5e81fdf4f0aa3d85"
...
def test_shared_runtime_pin_is_exposed_and_no_longer_floats() -> None:
    ...
    pinned_ref = str(pins["components"]["hermes-agent"]["ref"])

    expect(
        "__pins_get_or_default hermes-agent ref" in common_text,
        common_text,
    )
