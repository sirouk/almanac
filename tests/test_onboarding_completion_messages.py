...
def test_completion_bundle_lists_resources_and_scrubs_password() -> None:
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        try:
            ...
            expect("Shared Almanac rails:" in followup_text, followup_text)
            expect("https://kor.tail77f45e.ts.net/" in followup_text, followup_text)
            expect("https://kor.tail77f45e.ts.net/mcp" in followup_text, followup_text)
            expect("https://kor.tail77f45e.ts.net/almanac-mcp" in followup_text, followup_text)
            expect("QMD MCP retrieval rail: https://kor.tail77f45e.ts.net/mcp" in followup_text, followup_text)
            expect("Almanac MCP control rail: https://kor.tail77f45e.ts.net/almanac-mcp" in followup_text, followup_text)
