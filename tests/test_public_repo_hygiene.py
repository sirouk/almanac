...
PROVIDER_CODE_PATHS = {
    ...
    Path("docs/arclink/llm-router.md"),
    Path("docs/arclink/live-e2e-secrets-needed.md"),
    Path("docs/arclink/operations-runbook.md"),
    Path("docs/arclink/sovereign-control-node.md"),
    Path("docs/arclink/sovereign-control-node-symphony.md"),
    Path("docs/openapi/arclink-v1.openapi.json"),
    Path("python/arclink_api_auth.py"),
    Path("python/arclink_chutes.py"),
    Path("python/arclink_chutes_live.py"),
    Path("python/arclink_chutes_oauth.py"),
    Path("python/arclink_hosted_api.py"),
    Path("python/arclink_llm_router.py"),
    Path("python/arclink_llm_model_sync.py"),
    Path("python/arclink_dashboard.py"),
    Path("python/arclink_diagnostics.py"),
    Path("python/arclink_live_journey.py"),
    Path("python/arclink_live_runner.py"),
    Path("python/arclink_executor.py"),
    Path("python/arclink_provisioning.py"),
    Path("python/arclink_product.py"),
    Path("python/arclink_secrets_regex.py"),
    ...
    Path("python/arclink_operator_agent.py"),
    Path("python/arclink_sovereign_worker.py"),
    Path("tests/test_arclink_api_auth.py"),
    ...
    Path("tests/test_arclink_operator_agent.py"),
    ...
    Path("tests/test_arclink_llm_router.py"),
    Path("tests/test_arclink_llm_model_sync.py"),
