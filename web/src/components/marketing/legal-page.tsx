    ...
    <div className="bg-[#080808]">
      ...
      <main className="pb-24 pt-32">
        <div className="mx-auto max-w-3xl px-6 lg:px-8">
          <span className="font-mono text-xs uppercase tracking-widest text-[#FB5005]">{eyebrow}</span>
          <h1 className="font-heading mt-4 mb-3 text-4xl font-normal leading-tight text-[#E7E6E6] lg:text-5xl">
            {title}
          </h1>
          <p className="font-body mb-16 text-sm text-[#E7E6E6]/30">Last updated: {lastUpdated}</p>
